...
export default class grabDriver extends Component {
  ...
  componentWillMount() {
    ...
    this.pusher = new Pusher('029ae7d42952d804e948', {
    ...
    this.watchId = navigator.geolocation.watchPosition(
      (position) => {
        ...
        this.setState({
         ...
         console.log('component coumted 1')
      ...
      { 
        enableHighAccuracy: false, timeout: 200000, maximumAge: 100000, distanceFilter: 0
      },
    );
